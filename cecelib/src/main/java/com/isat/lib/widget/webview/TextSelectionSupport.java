...
package com.isat.lib.widget.webview;
...
import com.isat.lib.widget.drag.DragController;
import com.isat.lib.widget.drag.DragController.DragBehavior;
import com.isat.lib.widget.drag.DragLayer;
import com.isat.lib.widget.drag.DragListener;
import com.isat.lib.widget.drag.DragSource;
import com.isat.lib.widget.drag.MyAbsoluteLayout;
...
public class TextSelectionSupport implements TextSelectionControlListener, OnTouchListener, OnLongClickListener, DragListener {
    ...
    public void selectionChanged(String range, String text, String handleBounds, boolean isReallyChanged) {
        ...
        try {
            LogUtil.i(TAG, "range:" + range + " text:" + text);
    ...
    public boolean onLongClick(View v) {
        ...
        if (!isInSelectionMode()) {
            LogUtil.i(TAG, "mWebView.loadUrl");
