package com.isat.lib.widget.progress;
...
/**
 * 
* @Title: HoloCircularProgressBar.java 
* @Package com.isat.toefl.com.isat.toefl.widget.progress
* @Description: 环形进度条 
* @author brian.hou
* @date 2014-11-21 上午8:50:18 
* @version V1.0
 */
public class HoloCircularProgressBar extends View {
    ...
    public void setProgress(float progress) {
    	//避免float出现误差
    	if ( Math.abs(progress - mProgress) < .0000001 ){
    		 return;
    	}
