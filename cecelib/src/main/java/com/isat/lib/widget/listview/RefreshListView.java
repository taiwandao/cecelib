...
public class RefreshListView extends ListView implements OnScrollListener, OnClickListener{
	...
	public void onRefreshComplete()
	{
		...
		mLastUpdateTextView.setText(mContext.getString(R.string.lastest_update) + new Date().toLocaleString());
	...
	{
		mHeadView = LayoutInflater.from(context).inflate(R.layout.view_refresh_list_head, null);
	...
	{
		mFootView= LayoutInflater.from(context).inflate(R.layout.view_refresh_list_foot, null);
	...
	{	
		...
		switch(state)
		{
			case IListViewState.LVS_NORMAL:
			{
				...
				mArrowImageView.setImageResource(R.drawable.ic_refresh_arrow);
			}
				break;
			case IListViewState.LVS_PULL_REFRESH:
			{
			...
			case IListViewState.LVS_RELEASE_REFRESH:
			{
				...
				mHeadProgressBar.setVisibility(View.GONE);
				mArrowImageView.setVisibility(View.VISIBLE);
				mRefreshTextview.setText(mContext.getString(R.string.loosen_get_more));
				mArrowImageView.clearAnimation();
			...
			case IListViewState.LVS_LOADING:
			{
				...
				mRefreshTextview.setText(R.string.pull_to_refresh_refreshing_label);
			}
				break;
				default:
					return;
	...
	private void updateLoadMoreViewState(int state)
	{
		switch(state)
		{
			case ILoadMoreViewState.LMVS_NORMAL:
				...
				mLoadMoreTextView.setText(mContext.getString(R.string.see_more));
				break;
			...
			case ILoadMoreViewState.LMVS_OVER:
				mLoadingView.setVisibility(View.GONE);
				mLoadMoreTextView.setVisibility(View.VISIBLE);
				mLoadMoreTextView.setText(mContext.getString(R.string.data_is_complete));
				break;
				default:
					break;
		}
	...
	public void showRefushHeadView(){
		mHeadView.setPadding(0, 0, 0, 0);
		switchViewState(IListViewState.LVS_LOADING);
	}
